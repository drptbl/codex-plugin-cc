...
test("setup command can offer Codex install and still points users to codex login", () => {
  ...
  assert.match(setup, /argument-hint:\s*'\[--enable-review-gate\|--disable-review-gate\] \[--enable-auto-account-switch\|--disable-auto-account-switch\] \[--auto-switch-threshold <percent>\]'/);
